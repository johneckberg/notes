...
- A description of a research protype. "We modify and extend this architecture such that it works with very few training images and yields more precise segmentations"

2. Context: Which other papers is it related to? Which theoretical bases were used to analyze the problem?

- Related to both other deep image processing architectures.
